package lab4.oop.exercise.composition.authorbook;

public class TestMain {
    public static void main(String[] args) {
        Author author1 = new Author("Tan Ah Teck", "ahteck@gmail.com");
        System.out.println(author1);
        author1.setEmail("amen@gmail.com");
        System.out.println(author1);
        System.out.println("name is: " + author1.getName());
        System.out.println("email is: " + author1.getEmail());
        Book book1 = new Book("1234", "java for dummies", author1, 8.8, 88);
